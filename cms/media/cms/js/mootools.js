...
}});document.extend(Element.Methods.Dom);Element.extend(Element.Methods.Dom);Element.extend({scrollTo:function(A,B){this.scrollLeft=A;this.scrollTop=B;
